...
--
-- Before this sprint, the live scalper called loadActiveStrategy('edmund-s1-long')
...
--
-- Edmund's row is backfilled to edmund-s1-long v2 so his scalper keeps working
-- after this deploy.
